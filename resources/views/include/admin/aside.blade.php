      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('categories.index') }}"><i class="fa fa-list"></i> Danh mục bài viết</a></li>
            <li><a href="{{ route('categories.create') }}"><i class="fa fa-plus"></i> Thêm mới bài viết</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li>
          <a href="pages/calendar.html">
            <i class="fa fa-calendar"></i> <span>Cấu hình</span>
            <span class="pull-right-container">
